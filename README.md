...
| Tâche                                                                                       | Priorité | Date de début   | Date de fin | Etapes                                                                                                                                                                                               | Référence |
| ------------------------------------------------------------------------------------------------------ |----|------------|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|
...
| Refactoring general et bonnes pratiques                                                                | P2 | 29/01/2026 | 01/02/2026 | Revue globale du code source sur une branche dediee. Renommage des variables selon leur scope / veiller a l'architecture par composants / ajouter les namespace manquants                                | [branch](https://github.com/kzlucas/infinite-runner/tree/refactoring) | 
