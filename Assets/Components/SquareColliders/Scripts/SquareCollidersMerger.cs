...
namespace Assets.Components.SquareColliders.Scripts
{
    ...
    public class SquareCollidersMerger: MonoBehaviour, IService
    {
        ...
        public void GenerateSquareColliders()
        {
            ...
            squareCollidersBehaviour = UnityEngine.Object.FindFirstObjectByType<SquareCollidersBehaviour>();
            squareCollidersBehaviour.Clear();
            squareColliders = squareCollidersBehaviour.Collect();
            ...
            squareCollidersBehaviour.DeactivateAll(squareColliders);
        }
        ...
        /// </summary>
        private List<Vector3> GetColliderPoints(Collider collider)
        {
        ...
        /// </summary>
        private Collider GenerateColliderFromPointsList(TypedCollider typedCollider)
        {
            ...
            // Create GameObject with MeshCollider and return it
            return squareCollidersBehaviour.Push(mesh, typedCollider);
        }
    }
}
